...
module.exports = () => {
  ...
  passport.serializeUser((user, done) => { // req.session(세션) 객체에 어떤 데이터를 저장할지 선택
  ...
  passport.deserializeUser((id, done) => {  // serializeUser의 done에서 사용한 두 번째 인수가 deserializeUser의 첫번째 매개변수가 된다.
