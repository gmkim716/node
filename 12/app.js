...
const ColorHash = require("color-hash"); // color-hash: 문자열을 색상으로 바꿔주는 모듈
...
const connect = require("./schemas"); // schemas/index.js 파일을 불러옴
...
app.use(sessionMiddelware); // 세션을 다루는 미들웨어
// 세션을 다루는 미들웨어
app.use(
  session({
    resave: false,
